<!--
cavestack is AI-coded and proud of it. The bar is EVIDENCE OF REAL USE, not lines
...
<!-- Attach a screenshot of your own machine with the text `CAVESTACK PR` typed LIVE
...
overlaid, or edited onto the image. A painted-on `CAVESTACK PR` is an automatic
close. This confirms a human opened this PR. -->

## Checklist

- [ ] Liveness screenshot attached: `CAVESTACK PR` typed live into a real surface (not edited onto the image)
