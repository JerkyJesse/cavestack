...
- cavestack installed (`git clone --single-branch --depth 1 https://github.com/JerkyJesse/cavestack.git ~/.claude/skills/cavestack && cd ~/.claude/skills/cavestack && ./setup`)
...
- **If you want to understand why the four quadrants exist:** read [explanation-diataxis-in-cavestack.md](./explanation-diataxis-in-cavestack.md).
