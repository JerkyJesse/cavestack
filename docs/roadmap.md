# CaveStack Roadmap (Deferred, Not Promised)

CaveStack v1.0.0.0 is a **finished product** milestone. Items below are
considered but NOT promised. They may or may not ship in a future release.
No version targets, no timelines. They exist because we don't want to lose
the thinking that went into them.

If you want one of these to happen sooner, file an issue and say why:
https://github.com/JerkyJesse/cavestack/issues
...
**Effort:** S
**Priority:** P2
**Depends on:** `JerkyJesse/team-supabase-store` branch landing on main
