...
- cavestack installed (`./setup` complete; verify with `which cavestack` or by typing `/` in Claude Code and seeing skills listed)
...
- **Why cavestack uses the Diataxis framework:** [explanation-diataxis-in-cavestack.md](./explanation-diataxis-in-cavestack.md)
