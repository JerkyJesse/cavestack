// AUTO-GENERATED from cavestack/ios-qa/templates/StateServer.swift.template
...
public final class StateServer {
    ...
    private let logger = Logger(subsystem: "cavestack.ios-qa", category: "StateServer")
    ...
    private init(port: UInt16 = 9999) {
        ...
        self.bootTokenPath = NSTemporaryDirectory() + "cavestack-ios-qa.token"
    }
    ...
    public func start() {
        ...
        logger.notice("cavestack-ios-qa-bootstrap port=\(self.port, privacy: .public) build=\(self.appBuildId, privacy: .public)")
