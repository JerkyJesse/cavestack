// Allowlist file at ~/.cavestack/ios-qa-allowlist.json. The single source of
...
export function defaultAllowlistPath(): string {
  return process.env.CAVESTACK_IOS_ALLOWLIST_PATH
    ?? join(homedir(), '.cavestack', 'ios-qa-allowlist.json');
}
