...
// ~/.cavestack/ios-qa-daemon.pid on startup. Second invocation discovers the
...
export function defaultPidfilePath(): string {
  return process.env.CAVESTACK_IOS_DAEMON_PIDFILE
    ?? join(homedir(), '.cavestack', 'ios-qa-daemon.pid');
}
