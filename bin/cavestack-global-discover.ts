#!/usr/bin/env bun
/**
 * cavestack-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   cavestack-global-discover --since 7d [--format json|summary]
 *   cavestack-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: cavestack-global-discover --since <window> [--format json|summary]
...
Examples:
  cavestack-global-discover --since 7d
  cavestack-global-discover --since 14d --format summary`);
}
