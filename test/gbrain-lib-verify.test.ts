/**
 * cavestack-gbrain-supabase-verify + cavestack-gbrain-lib.sh — Slice 3 of /setup-gbrain.
 *
 ...
 * skill template and by cavestack-gbrain-supabase-provision. Validates var
...
const VERIFY = path.join(ROOT, 'bin', 'cavestack-gbrain-supabase-verify');
...
describe('cavestack-gbrain-supabase-verify', () => {
  const VALID =
...
describe('cavestack-gbrain-lib.sh read_secret_to_env', () => {
