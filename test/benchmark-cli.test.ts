/**
 * cavestack-model-benchmark CLI tests (offline).
 *
...
const BIN = path.join(ROOT, 'bin', 'cavestack-model-benchmark');
...
describe('cavestack-model-benchmark prompt resolution', () => {
