/**
 * Contract tests for bin/cavestack-redact — exit codes, JSON shape, flags,
...
const BIN = path.resolve(import.meta.dir, "..", "bin", "cavestack-redact");
...
describe("cavestack-redact exit codes", () => {
  test("clean → 0", () => {
...
describe("cavestack-redact --json", () => {
...
describe("cavestack-redact --auto-redact", () => {
...
describe("cavestack-redact --allowlist", () => {
...
describe("cavestack-redact --self-email", () => {
...
describe("cavestack-redact --from-file", () => {
...
describe("cavestack-redact oversize fails closed", () => {
...
describe("cavestack-redact argv dispatch", () => {
  ...
  // "scan" is what the human output header ("cavestack-redact scan — repo …")
