 ...
 *
 * Single source of truth mapping each cavestack skill to its E2E test files.
...
export const SKILL_COVERAGE: Record<string, SkillCoverage> = {
  ...
  'cavestack-upgrade': { gate: ['test/skill-coverage-floor.test.ts'], periodic: [] },
  ...
  'open-cavestack-browser': { gate: ['test/skill-coverage-floor.test.ts'], periodic: [] },
  ...
  // ─── CaveStack-only (caveman voice + helpers) ───────────────
  caveman: { gate: ['test/skill-coverage-floor.test.ts'], periodic: [] },
  'caveman-commit': { gate: ['test/skill-coverage-floor.test.ts'], periodic: [] },
  'caveman-help': { gate: ['test/skill-coverage-floor.test.ts'], periodic: [] },
  'caveman-review': { gate: ['test/skill-coverage-floor.test.ts'], periodic: [] },
  help: { gate: ['test/skill-coverage-floor.test.ts'], periodic: [] },
  checkpoint: { gate: ['test/skill-coverage-floor.test.ts'], periodic: [] },
};
