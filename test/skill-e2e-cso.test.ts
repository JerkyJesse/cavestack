...
- Save the report to .cavestack/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.cavestack', 'security-reports');
...
- Skip the preamble (cavestack-update-check, telemetry, etc.) — go straight to the audit.
