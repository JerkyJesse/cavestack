...
export const CARVE_GUARDS: Record<string, CarveGuard> = {
  ship: {
    ...
    staticInvariants: {
      ...
      mustStayInSkeleton: ['v$NEW_VERSION', 'cavestack-pr-title-rewrite'],
    ...
    maxSkeletonBytes: 93_600, // CaveStack caveman-full preamble ~1.3KB over gstack 1.68 budget; measured 92,939
  ...
  'plan-ceo-review': {
    ...
    maxSkeletonBytes: 95_900, // CaveStack caveman-full preamble ~1.3KB over gstack 1.68 budget; measured 95,193
  ...
  'plan-eng-review': {
    ...
    maxSkeletonBytes: 73_800, // CaveStack caveman-full preamble ~1.2KB over gstack 1.68 budget; measured 72,989
  ...
  'plan-design-review': {
    ...
    maxSkeletonBytes: 93_700, // CaveStack caveman-full preamble ~1.4KB over gstack 1.68 budget; measured 93,067
    minUnionBytes: 70_000,
  ...
  'plan-devex-review': {
    ...
    // #2499 project-scope MCP jq in the brain-sync block grew every tier-2+
    // skeleton ~1.5KB (entry resolution emitted once per SKILL.md).
    maxSkeletonBytes: 85_500, // CaveStack caveman-full preamble ~1.2KB over gstack 1.68 budget; measured 84,717
    minUnionBytes: 70_000,
  ...
  'office-hours': {
    ...
    // #2499 project-scope MCP jq in the brain-sync block grew every tier-2+
    // skeleton ~1.5KB (entry resolution emitted once per SKILL.md).
    maxSkeletonBytes: 104_800, // CaveStack caveman-full preamble ~1.6KB over gstack 1.68 budget; measured 104,356
    minUnionBytes: 70_000,
  ...
  'document-release': {
    ...
    // always-loaded AskUserQuestion Format section.
    // v1.2.0 activation lift: first-run-guidance section in the shared preamble.
    maxSkeletonBytes: 59_900, // CaveStack caveman-full preamble ~1.2KB over gstack 1.68 budget; measured 59,068
  ...
  'design-consultation': {
    ...
    maxSkeletonBytes: 73_400, // CaveStack caveman-full preamble ~1.3KB over gstack 1.68 budget; measured 72,697
  ...
  cso: {
    ...
    // always-loaded AskUserQuestion Format section.
    // v1.2.0 activation lift: first-run-guidance section in the shared preamble.
    maxSkeletonBytes: 79_300, // CaveStack caveman-full preamble ~1.1KB over gstack 1.68 budget; measured 78,445
    minUnionBytes: 72_000,
