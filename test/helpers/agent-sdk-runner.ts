 ...
 *
 * Default capacity 3. Override via CAVESTACK_SDK_MAX_CONCURRENCY env var.
 */
class Semaphore {
...
const DEFAULT_SDK_CONCURRENCY = Number(process.env.CAVESTACK_SDK_MAX_CONCURRENCY ?? 3);
...
export async function runAgentSdkTest(
  ...
  // scrub + ANTHROPIC_API_KEY + hermetic CLAUDE_CONFIG_DIR/CAVESTACK_HOME), with
