/**
 * cavestack-gbrain-mcp-verify — error-classification tests with a mocked curl.
 *
...
const VERIFY_BIN = path.join(ROOT, 'bin', 'cavestack-gbrain-mcp-verify');
...
beforeEach(() => {
  tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'cavestack-mcp-verify-test-'));
...
describe('cavestack-gbrain-mcp-verify', () => {
