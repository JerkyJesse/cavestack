 ...
 * (~/.cavestack/projects/<slug>/evals/) and compares the latest run against
 * its predecessor.
 *
 ...
 *
 * Override: CAVESTACK_BUDGET_RATIO=<n> (default 2.0).
 *
 ...
 *                                   ~/.cavestack/analytics/spend-overrides.jsonl
 *
