/**
 * bin/cavestack-developer-profile — subcommand behavior tests.
 *
 * Covers:
...
beforeEach(() => {
  tmpHome = fs.mkdtempSync(path.join(os.tmpdir(), 'cavestack-test-'));
});
...
describe('cavestack-developer-profile --read', () => {
...
describe('cavestack-developer-profile --migrate', () => {
...
describe('cavestack-developer-profile tier calculation', () => {
...
describe('cavestack-developer-profile --derive', () => {
...
describe('cavestack-developer-profile --trace <dim>', () => {
...
describe('cavestack-developer-profile --gap', () => {
...
describe('cavestack-developer-profile --vibe', () => {
...
describe('cavestack-developer-profile --check-mismatch', () => {
...
describe('cavestack-developer-profile errors', () => {
...
describe('cavestack-developer-profile --log-session (#1671 fix)', () => {
  ...
  test('silently skips invalid JSON input (matches cavestack-timeline-log pattern)', () => {
...
describe('cavestack-developer-profile resources entries do not inflate count/tier/nudge', () => {
