/**
 * bin/cavestack-question-log — schema validation + injection defense tests.
 */
...
const BIN = path.join(ROOT, 'bin', 'cavestack-question-log');
...
describe('cavestack-question-log — valid payloads', () => {
...
describe('cavestack-question-log — rejected payloads', () => {
...
describe('cavestack-question-log — injection defense', () => {
  const attacks = [
...
describe('cavestack-question-log — shared injection patterns (#1934 dedup)', () => {
