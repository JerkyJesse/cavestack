...
```bash
~/.claude/skills/cavestack/bin/cavestack-learnings-log '{"skill":"ship","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
...
```bash
~/.claude/skills/cavestack/bin/cavestack-learnings-search --query "<your-keyword>" --limit 5 2>/dev/null || true
```
