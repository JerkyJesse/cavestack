...
//
// cavestack's native shape is a plain-text VERSION file at the repo root holding a
// 4-digit MAJOR.MINOR.PATCH.MICRO — and for cavestack itself that file STAYS the
...
//      build injects it). The --version-path / .cavestack/version-path pin already
...
//      components, so cavestack-next-version exited 2 ("could not parse base
...
/**
 * The npm-valid form of a cavestack version. npm's semver is 3-component and
