/**
 * cavestack-decision — event-sourced institutional decision memory.
 *
...
/** Resolve the per-project decision store paths. Bins pass slug + CAVESTACK_HOME. */
export function decisionPaths(slug: string, cavestackHome?: string): DecisionPaths {
