/**
 * jsonl-store — shared plumbing for cavestack's append-only JSONL stores in
 ...
 *      today: bin/cavestack-learnings-log, bin/cavestack-decision-log (via
 *      lib/cavestack-decision.ts), bin/cavestack-question-log.
 ...
 *
 * Extracted from `bin/cavestack-learnings-log` (D2A) so the learnings/decision/
