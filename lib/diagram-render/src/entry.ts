...
window.EXCALIDRAW_ASSET_PATH = "https://cavestack-render.localhost/excalidraw-assets/";
...
window.__mermaidToExcalidraw = async (text: string): Promise<string> => {
  ...
  const scene = {
    type: "excalidraw",
    version: 2,
    source: "cavestack-diagram-render",
    elements: converted,
...
window.__bundleInfo = { name: "cavestack-diagram-render", deps: __BUNDLE_INFO_DEPS__ };
