 ...
 *
 * cavestack does not maintain a home-grown indexer. It defines this small contract
 ...
 * reliability contract as lib/cavestack-decision-semantic.ts.
 *
 ...
 * same semantics as runCodeImport in bin/cavestack-gbrain-sync.ts ("code ingest
...
export interface OpOptions {
   ...
   * CLI on PATH, temp CAVESTACK_HOME). Matches the existing gbrain helpers.
   */
