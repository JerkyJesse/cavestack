 ...
 *
 * Adapted from time-attack/cavestack's THIRD-PARTY-ACTIONS.md (CaveStack 2, MIT):
 * the fork detected the Aside AI browser; we drive our own stack — browse
 * headed mode + handoff/resume ($B), CaveStack Browser, and pair-agent.
 * Portions copyright (c) 2026 Sina Matian, time-attack/cavestack, MIT.
 */
