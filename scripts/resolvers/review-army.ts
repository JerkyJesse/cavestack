 ...
 * 1. Detect stack and scope (via cavestack-diff-scope)
...
\`\`\`bash
source <(${ctx.paths.binDir}/cavestack-diff-scope <base> 2>/dev/null) || true
...
\`\`\`bash
${ctx.paths.binDir}/cavestack-specialist-stats 2>/dev/null || true
\`\`\`
...
\`\`\`bash
${ctx.paths.binDir}/cavestack-learnings-search --type pitfall --query "{specialist domain}" --limit 5 2>/dev/null || true
\`\`\`
