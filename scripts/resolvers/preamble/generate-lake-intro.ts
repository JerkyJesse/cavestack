...
Only run \`open\` if yes. Always run \`touch\`.`;
  ...
  return `If \`LAKE_INTRO\` is \`no\`: say "cavestack follows the **Boil the Ocean** principle — do the complete thing when AI makes marginal cost near-zero. Read more: https://garryslist.org/posts/boil-the-ocean" Offer to open:
