/**
 * Question Registry — typed schema for AskUserQuestion invocations across cavestack.
 *
 * Purpose
 * -------
 ...
 *
 * Not every AskUserQuestion in cavestack needs a registry entry right away. Skills
...
export interface QuestionDef {
  ...
  id: string;
  /** Skill that owns this question (must match a cavestack skill directory name) */
  skill: string;
...
export const QUESTIONS = {
  ...
  // -----------------------------------------------------------------------
  // /cavestack-upgrade — version upgrade
  // -----------------------------------------------------------------------
  'cavestack-upgrade-inline': {
    id: 'cavestack-upgrade-inline',
    skill: 'cavestack-upgrade',
    category: 'approval',
    door_type: 'two-way',
    options: ['yes-upgrade', 'always-auto', 'not-now', 'never-ask'],
    description: "Upgrade cavestack now? (Also: always auto-upgrade, snooze, or disable the prompt.)",
  },
  ...
  'preamble-telemetry-consent': {
    ...
    description: "Share usage data with cavestack? community (recommended) / anonymous / off",
  },
  'preamble-proactive-behavior': {
    ...
    door_type: 'two-way',
    options: ['on', 'off'],
    description: "Let cavestack proactively suggest skills based on conversation context?",
  },
  'preamble-routing-injection': {
    ...
    description: "Add cavestack skill routing rules to CLAUDE.md?",
  },
  'preamble-vendored-migration': {
    ...
    description: "This repo has vendored cavestack (deprecated) — migrate to team mode?",
  },
